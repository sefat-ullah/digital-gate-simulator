...
public class Verticalbar extends JPanel {
    ...
    public Verticalbar() {
        ...
        JToolBar selectBar = new JToolBar(JToolBar.HORIZONTAL);
        selectBar.setBorder(BorderFactory.createLineBorder(Color.WHITE));

        select = new JButton("S");
        select.setToolTipText("Selection Mode");
        component = new JButton("C");
        component.setToolTipText("Move");
        track = new JButton("WIRE");
        select.setToolTipText("Wire");
